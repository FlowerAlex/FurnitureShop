...
class _$OrdersScreenStateTearOff {
  ...
  OrdersScreenStateInitial initial() {
    return const OrdersScreenStateInitial();
  }
...
mixin _$OrdersScreenState {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(OrdersScreenStateInitial value) initial,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    TResult Function(OrdersScreenStateInitial value)? initial,
...
/// @nodoc
abstract class $OrdersScreenStateInitialCopyWith<$Res> {
  factory $OrdersScreenStateInitialCopyWith(OrdersScreenStateInitial value,
          $Res Function(OrdersScreenStateInitial) then) =
      _$OrdersScreenStateInitialCopyWithImpl<$Res>;
}

/// @nodoc
class _$OrdersScreenStateInitialCopyWithImpl<$Res>
    extends _$OrdersScreenStateCopyWithImpl<$Res>
    implements $OrdersScreenStateInitialCopyWith<$Res> {
  _$OrdersScreenStateInitialCopyWithImpl(OrdersScreenStateInitial _value,
      $Res Function(OrdersScreenStateInitial) _then)
      : super(_value, (v) => _then(v as OrdersScreenStateInitial));

  @override
  OrdersScreenStateInitial get _value =>
      super._value as OrdersScreenStateInitial;
}

/// @nodoc

class _$OrdersScreenStateInitial implements OrdersScreenStateInitial {
  const _$OrdersScreenStateInitial();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is OrdersScreenStateInitial);
  }
...
abstract class OrdersScreenStateInitial implements OrdersScreenState {
  const factory OrdersScreenStateInitial() = _$OrdersScreenStateInitial;
}
...
abstract class OrdersScreenStateReady implements OrdersScreenState {
  const factory OrdersScreenStateReady(
      {required Map<String, OrderDTO> orders,
      required int currentPage,
      required int totalCount}) = _$OrdersScreenStateReady;
