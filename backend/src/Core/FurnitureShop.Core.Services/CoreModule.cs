...
namespace FurnitureShop.Core.Services
{
    public class CoreModule : AppModule
    {
        ...
        public CoreModule(
            ...
            string modelsContainerName,
            string photosContainerName
        )
        {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<CoreDbContext>(
                opts =>
                    opts.UseSqlServer(
                        connectionString,
                        cfg => cfg.MigrationsAssembly("FurnitureShop.Migrations")
                    )
            );
            ...
            services.AddTransient<
                IBlobStorageService,
                BlobStorageService
            >( /*b => new BlobStorageService(blobConnectionString,modelsContainerName,photosContainerName)*/
            );
        }
